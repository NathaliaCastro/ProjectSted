        ...
        success: function (data) {
            ...
            data.forEach(function (Entitie) {
                ...
                if (Entitie.url != null && Entitie.url != "" && Entitie.url != undefined) {
                    ...
                    htmlConteudo += "<img width='80' height='80' src='" + Entitie.url + "'/></br>";
                }

                htmlConteudo += "<label>  Promoção: " + Entitie.promocao + "</label></br>";

                htmlConteudo += "<label>  Valor: R$ " + Entitie.valor + "</label></br>";
            ...
            if (data.sucesso && qtd >= 1) {
                // 1 alert-success// 2 alert-warning// 3 alert-danger
                ObjetoAlerta.AlertarTela(1, "Promocao aplicada");
